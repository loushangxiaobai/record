...
<div class="banner" style="margin-bottom: 20px">
    <div class="am-g am-container padding-none">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 padding-none">
            <div data-am-widget="slider" class="am-slider am-slider-c1" data-am-slider='{"directionNav":false}' >
                <ul class="am-slides">
                                        <li>
                        <img src="<c:url value="/static/image/portal/news/1453178666515423.jpg"/>">
                        <div class="am-slider-desc">"娜喊杯"圆满落幕 聚合HTML5资源构建完善生态圈</div>
                    </li>
                                        <li>
                        <img src="<c:url value="/static/image/portal/news/1451816278867404.jpg"/>">
	...
	<div class="star am-container mcenter">
		<span><img src="<c:url value="/static/image/portal/news/star.png"/>">游戏案例</span>
	</div>
		...
		<ul data-am-widget="gallery"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467345575957477.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467344792865637.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467342514896051.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467342368966457.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467182617637173.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467182337436061.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467181606105258.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467103687947896.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467009483501160.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467009063287196.jpg"/>"
	...
	<!--工具案例-->
	<div class="star am-container mcenter">
		<span><img src="<c:url value="/static/image/portal/news/star.png"/>">工具案例</span>
	</div>
	<div class="am-container">
		<ul data-am-widget="gallery"
			class="am-gallery am-avg-sm-2 am-avg-md-4 am-avg-lg-6 am-gallery-bordered am-no-layout"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1464599154741066.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1464332323543195.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1464244873804151.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1464243349986286.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451281639110488.png"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451902354799644.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451902540302052.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451902238537988.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451280250115832.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1451280166111069.jpg"/>"
	...
	<!--工具案例-->
	<div class="star am-container mcenter">
		<span><img src="<c:url value="/static/image/portal/news/star.png"/>">营销案例</span>
	</div>
	<div class="am-container">
		<ul data-am-widget="gallery"
			class="am-gallery am-avg-sm-2 am-avg-md-4 am-avg-lg-6 am-gallery-bordered am-no-layout"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467352634432203.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src="<c:url value="/static/image/portal/news/1467351848472544.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1467184527541800.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1467007695195054.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1467006900788944.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1466060362764699.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1464596810835659.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1464571479405621.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1464333747649028.jpg"/>'
			...
			<li>
				<div class="am-gallery-item">
					<img src='<c:url value="/static/image/portal/news/1464333377933527.jpg"/>'
	...
	<div class="content">
		...
		<a href="http://amazeui.org/" class="support"> <span>自豪的使用
				Amaze UI</span> <img src="<c:url value="/static/image/portal/news/amazeui-logo.png"/>">
		</a>
