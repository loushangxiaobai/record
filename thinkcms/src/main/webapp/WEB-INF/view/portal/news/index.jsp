...
<![endif]-->
<head>
<%@ include file="/WEB-INF/view/portal/news/portalHead.jsp"%>
</head>
<body>
	<!--header-->
		...
		<div class="am-container">
			<h1 class="am-topbar-brand">
				<a href="http://www.html5dw.com/#"><img
					src="<c:url value="/static/image/portal/news/"/>logo_new.png" alt=""></a>
			</h1>
			<button
		...
		<div class="am-g am-container">
						...
						<ul class="am-slides"
							...
							<li class="clone" aria-hidden="true"
								...
								href="http://2016.html5dw.com/beijing"> <img
									src="<c:url value="/static/image/portal/news/1467872304674586.jpg"/>"
									draggable="false">
							...
							<li class="" style="width: 807px; float: left; display: block;">
								<a href="http://www.html5dw.com/post?id=1704"> <img
									src="<c:url value="/static/image/portal/news/1467265137717304.jpg"/>"
									draggable="false">
							...
							<li style="width: 807px; float: left; display: block;" class="">
								<a href="http://www.html5dw.com/post?id=1720"> <img
									src="<c:url value="/static/image/portal/news/1467789636224488.jpg"/>"
									draggable="false">
							...
							<li style="width: 807px; float: left; display: block;" class="">
								<a href="http://2016.html5dw.com/shanghai/review"> <img
									src="<c:url value="/static/image/portal/news/1466128716152836.jpg"/>"
									draggable="false">
			...
			<div class="am-u-sm-0 am-u-md-0 am-u-lg-4 padding-none am-hide-sm">
				<div class="star am-container">
					<span><img
						src="<c:url value="/static/image/portal/news/"/>star.png">荣誉榜</span>
				</div>
				<ul
					...
					<li>
						<div class="am-gallery-item">
							<a href="http://www.html5dw.com/post?id=1627"> <img
								src="<c:url value="/static/image/portal/news/1465718540605838.jpg"/>"
								alt="乐天时代">
					...
					<li>
						<div class="am-gallery-item">
							<a href="http://gc.hgame.com/redirect_mobile.html"> <img
								src="<c:url value="/static/image/portal/news/1456297783507853.jpg"/>"
								alt="蝴蝶互动">
					...
					<li>
						<div class="am-gallery-item">
							<a href="http://www.layabox.com/"> <img
								src="<c:url value="/static/image/portal/news/1456468424295770.jpg"/>"
								alt="LayaBox">
								<h3 class="am-gallery-title">
					...
					<li>
						<div class="am-gallery-item">
							<a
								...
								<img
								src="<c:url value="/static/image/portal/news/1456300606772969.jpg"/>"
								alt="爱微游">
	...
	<div class="am-container am-hide-sm">
		...
		<ul
			...
			<li>
				<div class="am-gallery-item">
					<a href="http://2016.html5dw.com/beijing"> <img
						src="<c:url value="/static/image/portal/news/1467873207367971.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<a href="http://2016.html5dw.com/beijing"> <img
						src="<c:url value="/static/image/portal/news/1467879242784328.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<a href="http://www.html5dw.com/post?id=1684"> <img
						src="<c:url value="/static/image/portal/news/1467343379859771.jpg"/>"
			...
			<li>
				<div class="am-gallery-item">
					<a href="http://www.html5dw.com/post?id=1711"> <img
						src="<c:url value="/static/image/portal/news/1467354560993360.jpg"/>"
					...
					<ul class="am-list">
						<li
							...
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1726"> <img
									src="<c:url value="/static/image/portal/news/1467956418575663.jpg"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/08</i> <i
								class="am-icon-hand-pointer-o">30</i>
						</div>
						<li
							...
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1725"> <img
									src="<c:url value="/static/image/portal/news/1467945024864131.gif"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/08</i> <i
								class="am-icon-hand-pointer-o">18</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1724"> <img
									src="<c:url value="/static/image/portal/news/1467944487954655.png"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/08</i> <i
								class="am-icon-hand-pointer-o">167</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1722"> <img
									src="<c:url value="/static/image/portal/news/1467881072716759.jpg"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/07</i> <i
								class="am-icon-hand-pointer-o">8</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1721"> <img
									src="<c:url value="/static/image/portal/news/1467879934733266.jpg"/>"
						...
						<li
							...
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1720"> <img
									src="<c:url value="/static/image/portal/news/1467789560110178.jpg"/>"
						...
						<li
							...
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1719"> <img
									src="<c:url value="/static/image/portal/news/1467621706973528.jpg"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/04</i> <i
								class="am-icon-hand-pointer-o">58</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1718"> <img
									src="<c:url value="/static/image/portal/news/1467621657575742.jpg"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/04</i> <i
								class="am-icon-hand-pointer-o">49</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1717"> <img
									src="<c:url value="/static/image/portal/news/1467616028687787.jpg"/>"
									alt="前端组件化开发实践" style="max-height: 320px">
								</a>
							</div>
							<div class=" am-u-sm-7 am-list-main">
								<h3 class="am-list-item-hd">
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/04</i> <i
								class="am-icon-hand-pointer-o">184</i>
						</div>
						<li
							class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left am-scrollspy-init"
							data-am-scrollspy="{animation:&#39;fade&#39;}">
							<div class="am-u-sm-5 am-list-thumb">
								<a href="http://www.html5dw.com/post?id=1716"> <img
									src="<c:url value="/static/image/portal/news/1467344237522493.jpg"/>"
						...
						<div class="newsico am-fr">
							<i class="am-icon-clock-o">2016/07/01</i> <i
								class="am-icon-hand-pointer-o">126</i>
						</div>
					</ul>
				</div>
				<!-- 通栏广告 -->
				<a href="http://www.html5dw.com/##"> <img
					src="<c:url value="/static/image/portal/news/1451814238234525.jpg"/>"
					...
					<div id="youxi" class="case am-animation-slide-left">
						<ul
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467345575957477.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467344792865637.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467342514896051.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467342368966457.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467182617637173.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467182337436061.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467181606105258.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467103687947896.jpg"/>"
					...
					<div id="yingxiao" class="case am-animation-slide-right dn">
						<ul
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467352634432203.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467351848472544.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467184527541800.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467007695195054.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1467006900788944.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1466060362764699.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464596810835659.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464571479405621.jpg"/>"
					...
					<div id="gongju" class="dn case am-animation-slide-right">
						<ul
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464599154741066.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464332323543195.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464244873804151.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1464243349986286.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1451281639110488.png"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1451902354799644.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1451902540302052.jpg"/>"
							...
							<li>
								<div class="am-gallery-item">
									<img
										src="<c:url value="/static/image/portal/news/1451902238537988.jpg"/>"
		...
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
			...
			<div data-am-widget="list_news"
				...
				<div class="am-u-sm-6 border-right">
					<img
						src="<c:url value="/static/image/portal/news/1465896287457679.jpg"/>"
						class="img-gg">
					<div class="am-text-center gz-text-color">微信公众号</div>
				</div>
				<div class="am-u-sm-6">
					<img
						src="<c:url value="/static/image/portal/news/1465896410977280.jpg"/>"
						class="img-gg">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=6"> <img
								src="<c:url value="/static/image/portal/news/1451891934911843.jpg"/>"
								class="face">
							</a>
						</div>
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=26"> <img
								src="<c:url value="/static/image/portal/news/1452484975381176.jpg"/>"
								class="face">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=7"> <img
								src="<c:url value="/static/image/portal/news/1451534129816716.jpg"/>"
								class="face">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=33"> <img
								src="<c:url value="/static/image/portal/news/1453257542318962.png"/>"
								class="face">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=14"> <img
								src="<c:url value="/static/image/portal/news/1451903850184832.jpg"/>"
								class="face">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb am-u-sm-4-gg">
							<a href="http://www.html5dw.com/category/?id=13"> <img
								src="<c:url value="/static/image/portal/news/1451903790999136.jpg"/>"
								class="face">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb">
							<a href="http://www.html5dw.com/post?id=1316"> <img
								src="<c:url value="/static/image/portal/news/1455703985863057.jpg"/>">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
							<h3 class="am-list-item-hd">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb">
							<a href="http://www.html5dw.com/post?id=1142"> <img
								src="<c:url value="/static/image/portal/news/1452076661702306.jpg"/>">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
							<h3 class="am-list-item-hd">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb">
							<a href="http://www.html5dw.com/post?id=1133"> <img
								src="<c:url value="/static/image/portal/news/1451902854251139.jpg"/>">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
							<h3 class="am-list-item-hd">
					...
					<li
						...
						<div class="am-u-sm-4 am-list-thumb">
							<a href="http://www.html5dw.com/post?id=1128"> <img
								src="<c:url value="/static/image/portal/news/1451902880696867.jpg"/>">
							</a>
						</div>
						<div class=" am-u-sm-8 am-list-main">
							<h3 class="am-list-item-hd">
				...
				<li>
					<div class="am-gallery-item">
						<a href="http://www.html5dw.com/event?id=19" class=""> <img
							src="<c:url value="/static/image/portal/news/1455678577886179.jpg"/>"
				...
				<li>
					<div class="am-gallery-item">
						<a href="http://www.html5dw.com/event?id=18" class=""> <img
							src="<c:url value="/static/image/portal/news/1455678259846107.jpg"/>"
							alt="第二届前端开发者大会">
				...
				<li>
					<div class="am-gallery-item">
						<a href="http://www.html5dw.com/event?id=20" class=""> <img
							src="<c:url value="/static/image/portal/news/1455680559761318.jpg"/>"
							alt="TFC全球移动游戏大会">
				...
				<li>
					<div class="am-gallery-item">
						<a href="http://www.html5dw.com/event?id=21" class=""> <img
							src="<c:url value="/static/image/portal/news/1456219498187374.jpg"/>"
	...
	<footer>
		<div class="content">
			...
			<a href="http://amazeui.org/" class="support"> <span>自豪的使用
					Amaze UI</span> <img
				src="<c:url value="/static/image/portal/news/amazeui-logo.png"/>">
			</a>
