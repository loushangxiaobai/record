		...
		<table class="am-table am-table-striped am-table-hover table-main">
			<thead>
				<tr>
					...
					<th class="table-title am-hide-sm-only">父级ID</th>
					<th class="table-title am-hide-sm-only">父级名称</th>
					<th class="table-date am-hide-sm-only">是否可用</th>
					<th class="table-date am-hide-sm-only">是否新页签打开</th>
			...
			<tbody>
				<c:forEach items="${list.items }" var="item">
					<tr>
						...
						<td class="am-hide-sm-only">${item.blank }</td>
						<td>
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<button type="button" class="am-btn am-btn-default am-text-secondary"
										onclick="openWindow('category/edit?id=${item.id}','栏目编辑');">
